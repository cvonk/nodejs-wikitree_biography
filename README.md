...
* Follow the steps shown at the left of the browser window
  ...
  3. Verify that the WikiTree profile matches the data from GEDCOM, and copy'n'past the generated bio on the left to WikiTree. Press preview. Press `merge` on WikiTree.
